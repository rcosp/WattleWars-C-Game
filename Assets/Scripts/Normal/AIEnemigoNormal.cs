...
public class AIEnemigoNormal : MonoBehaviour
{
    private GameObject target;
    private NavMeshAgent agente;
    private VidaEnemigoNormal vida;
    ...
    void Start()
    {
        ...
        vida = GetComponent<VidaEnemigoNormal>();
    ...
    void RevisarVida()
    {
        ...
        if(vida.valor <=0)
        {
            ...
            if(sumarPuntos)
            {
                puntosPantalla.GetComponent<Puntos>().valor += 20;
                sumarPuntos = false;
            }
            Vida0 = true;
